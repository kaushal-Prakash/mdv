    ...
    return (
      <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
        <View style={styles.emptyState}>
          ...
          <Text style={[styles.emptyText, { color: colors.text }]}>No file selected</Text>
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        <View style={styles.fileInfo}>
          ...
          {modified && <Text style={[styles.modifiedIndicator, { color: colors.accent }]}> ●</Text>}
        </View>
        ...
        <View style={styles.actions}>
          {isEditing ? (
            <>
              ...
              <TouchableOpacity onPress={handleCancel} style={[styles.cancelButton, { borderColor: colors.textSecondary }]}>
                <Text style={[styles.cancelButtonText, { color: colors.textSecondary }]}>Cancel</Text>
              </TouchableOpacity>
            </>
          ) : (
            <TouchableOpacity onPress={() => setIsEditing(true)} style={[styles.editButton, { borderColor: colors.accent }]}>
      ...
      <View style={[styles.statusBar, { backgroundColor: colors.titleBar, borderTopColor: colors.border }]}>
        <Text style={[styles.statusText, { color: colors.textSecondary }]}>
          {content.split('\n').length} lines • {content.length} characters
        </Text>
        <Text style={[styles.statusText, { color: colors.textSecondary }]}>Markdown</Text>
      </View>
    </SafeAreaView>
  );
}
